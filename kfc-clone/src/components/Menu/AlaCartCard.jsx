...
export default function AlaCartCard({AlaCartp}) {
  return (
    <div className='everydaycard relative max-w-[280px] min-w-[300px] h-[100%] mb-5  p-3 rounded-md bg-[#212529]'>
      ...
      <div className='image w-[100%] h-[180px] mb-3'>
        <img src={AlaCartp.image} alt='Everydaycardimage' className='w-[100%] h-[100%]'/>
      </div>
      <h4 className='text-2xl font-semibold mb-3'>{AlaCartp.title}</h4>
      <p className='mb-3'>{AlaCartp.description}</p>
      <div className='font-bold mb-4'>{AlaCartp.price}</div>
