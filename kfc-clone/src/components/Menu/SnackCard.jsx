...
<div className='image w-[100%] h-[180px] mb-3'>
  <img src={snack.image} alt='Everydaycardimage' className='w-[100%] h-[100%]'/>
</div>
<h4 className='text-2xl font-semibold mb-3'>{snack.title}</h4>
<p className='mb-3'>{snack.description}</p>
<div className='font-bold mb-4'>{snack.price}</div>
