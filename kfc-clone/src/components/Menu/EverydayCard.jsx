...
function EverydayCard({everycard}) {
  return (
    <div className='everydaycard relative max-w-[280px] min-w-[300px] h-[100%] mb-5  p-3 rounded-md bg-[#212529]'>
      ...
      <div className='image w-[100%] h-[180px] mb-3'>
        <img src={everycard.image} alt='Everydaycardimage' className='w-[100%] h-[100%]'/>
      </div>
      <h4 className='text-2xl font-semibold mb-3'>{everycard.title}</h4>
      <p className='mb-3'>{everycard.description}</p>
      <div className='font-bold mb-4'>{everycard.price}</div>
