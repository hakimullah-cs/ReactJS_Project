...
export default function MidnightCard({mid}) {
  return (
...
<div className='image w-[100%] h-[180px] mb-3'>
  <img src={mid.image} alt='Everydaycardimage' className='w-[100%] h-[100%]'/>
</div>
<h4 className='text-2xl font-semibold mb-3'>{mid.title}</h4>
<p className='mb-3'>{mid.description}</p>
<div className='font-bold mb-4'>{mid.price}</div>
